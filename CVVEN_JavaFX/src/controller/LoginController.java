...
public class LoginController implements Initializable {
    ...
    @FXML private TextField txtlogin;      // Dans votre code précédent c'était fieldLogin
    @FXML private PasswordField txtpassword; // Dans votre code précédent c'était fieldPsw
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // Cela signifie que si on appuie sur Entrée n'importe où, ça clique sur le bouton
        btnconn.setDefaultButton(true);

        // --- 2. Enlever le curseur du champ Login au démarrage ---
        // On utilise Platform.runLater car on doit attendre que la fenêtre soit affichée
        Platform.runLater(() -> {
