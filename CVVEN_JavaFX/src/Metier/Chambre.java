...
public class Chambre {
    ...
    public StringProperty chambIdProperty() { return chambId; }
    public IntegerProperty chambNumeroProperty() { return chambNumero; }
    public StringProperty chambEmplacementProperty() { return chambEmplacement; }
    public StringProperty chambRemarqueProperty() { return chambRemarque; }
    public type_Chambre typeLibelleProperty() { return type_chambre; }
    
    

    // Getters classiques
    public String getChambId() { return chambId.get(); }
    public int getChambNumero() { return chambNumero.get(); }
    public String getChambEmplacement() { return chambEmplacement.get(); }
    public String getChambRemarque() { return chambRemarque.get(); }
